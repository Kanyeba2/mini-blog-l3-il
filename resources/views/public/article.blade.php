...
@section('content')
    <div class="article-hero">
        <div class="breadcrumb">
            ...
            <span>/</span>
            <a href="{{ route('categories.index') }}">Optio</a>
            <span>/</span>
    ...
    <div class="article-layout">
        ...
        <aside class="sidebar">
            ...
            <div class="sidebar-block">
                ...
                <a href="{{ route('articles.show', ['slug' => 'aut-repellat']) }}" class="related-card">
                ...
                <a href="{{ route('articles.show', ['slug' => 'velit-ad-quo']) }}" class="related-card">
                    <div class="related-cat">Vitae</div>
                    <div class="related-title">Velit ad quo quo vel</div>
                    <div class="related-date">9 juillet 2009</div>
                </a>
                <a href="{{ route('articles.show', ['slug' => 'ut-iusto-veniam']) }}" class="related-card">
