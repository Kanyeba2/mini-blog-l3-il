...
@section('content')
    ...
    <section class="section" style="padding-bottom:0">
        ...
        <div class="categories-row">
            ...
            <a href="{{ route('categories.index') }}" class="cat-pill">Vitae</a>
            <a href="{{ route('categories.index') }}" class="cat-pill">Dignissimos</a>
            <a href="{{ route('categories.index') }}" class="cat-pill">Optio</a>
            <a href="{{ route('categories.index') }}" class="cat-pill">Aperiam</a>
            <a href="{{ route('categories.index') }}" class="cat-pill">Tenetur</a>
        </div>
    </section>
    ...
    <section class="section">
        ...
        <div class="articles-grid">
            <a href="{{ route('articles.show', ['slug' => 'excepturi-eligendi']) }}" class="article-card featured">
                <div class="article-cat">Vitae • À la une</div>
            ...
            <a href="{{ route('articles.show', ['slug' => 'aut-repellat']) }}" class="article-card">
            ...
            <a href="{{ route('articles.show', ['slug' => 'dignissimos-fugiat']) }}" class="article-card">
